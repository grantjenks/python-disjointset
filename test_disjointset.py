...
class TestStaticDisjointSet(unittest.TestCase):
    ...
    def test_initial_find(self):
        ...
        for i in range(5):
            self.assertEqual(self.ds.find(i), i,
                             msg=f"Element {i} should initially be its own root.")
    ...
    def test_union_and_match(self):
        ...
        self.assertFalse(self.ds.match(0, 1), msg="Elements 0 and 1 should not be connected initially.")
        self.ds.union(0, 1)
        self.assertTrue(self.ds.match(0, 1), msg="Elements 0 and 1 should be connected after union.")
        self.ds.union(1, 2)
        self.assertTrue(self.ds.match(0, 2), msg="Elements 0 and 2 should be connected after chained unions.")
        self.assertFalse(self.ds.match(3, 4), msg="Elements 3 and 4 should be in different sets initially.")
    ...
    def test_sets(self):
        ...
        self.assertEqual(self.ds.sets(), expected_initial,
        ...
        self.assertEqual(self.ds.sets(), expected_groups,
...
class TestDynamicDisjointSet(unittest.TestCase):
    ...
    def test_repeated_union(self):
        ...
        self.ds.union("a", "b")
        self.ds.union("b", "a")
        self.assertTrue(self.ds.match("a", "b"),
